	...
	>
		<div class="mx-3 flex flex-col gap-4 md:mx-5">
			<div>
				...
				{#if isLoadingPjl}
					<div class="mt-6 flex h-[70vh] flex-col justify-center">
						<div
									...
									<div class="ml-1 flex flex-col text-neutral-700">
										...
										<span class=""
											><iconify-icon
												class="mr-1 align-[-0.18em]"
												icon="ri:inbox-archive-line"
											></iconify-icon>Déposé le 14/10/2025 à l'Assemblée
											nationale
										</span>
										<span class=""
											><iconify-icon
									...
									<div class="ml-1 flex flex-col text-neutral-600">
										...
										<span class=""
											><iconify-icon
												class="mr-1 align-[-0.18em]"
												icon="ri:inbox-archive-line"
											></iconify-icon>Déposé le 15/12/2025 à l'Assemblée
											nationale
										</span>
										<span class=""
											><iconify-icon
									...
									<div class="ml-1 flex flex-col text-neutral-700">
										...
										<span class=""
											><iconify-icon
												class="mr-1 align-[-0.18em]"
												icon="ri:inbox-archive-line"
											></iconify-icon>Déposé le 26/11/2025 à l'Assemblée
											nationale
										</span>
										<span class=""
											><iconify-icon
									...
									<div class="ml-1 flex flex-col text-neutral-700">
										...
										<span class=""
											><iconify-icon
												class="mr-1 align-[-0.18em]"
												icon="ri:inbox-archive-line"
											></iconify-icon>Déposé le 12/12/2025 à l'Assemblée
											nationale
										</span>
										<span class=""
											><iconify-icon
									...
									<div class="ml-1 flex flex-col text-neutral-700">
										...
										<span class=""
											><iconify-icon
												class="mr-1 align-[-0.18em]"
												icon="ri:inbox-archive-line"
											></iconify-icon>Déposé le 18/11/2025 à l'Assemblée
											nationale
										</span>
										<span class=""
											><iconify-icon
